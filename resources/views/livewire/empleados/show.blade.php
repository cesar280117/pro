                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                        ...
                        <li class="list-group-item">
                            <b>ID de empleado</b> <a class="float-right">{{ $empleado->id }}</a>
                        </li>
                        <li class="list-group-item">
                            <b>Primer nombre</b> <a class="float-right">{{ $empleado->primer_nombre }}</a>
                        </li>

                        <li class="list-group-item">
                            <b>Segundo nombre</b> <a class="float-right">{{ $empleado->segundo_nombre }}</a>
                        </li>

                        <li class="list-group-item">
                            <b>Apellido paterno</b> <a class="float-right">{{ $empleado->apellido_paterno }}</a>
                        </li>

                        <li class="list-group-item">
                            <b>Apellido materno</b> <a class="float-right">{{ $empleado->apellido_materno }}</a>
                        </li>
                    ...
                    <a href="{{ route('empleados.index') }}" class="btn btn-primary btn-block"><b><i
                                class="fa fa-home"></i>
                            Regresar</b></a>
                </div>
                <!-- /.card-body -->
