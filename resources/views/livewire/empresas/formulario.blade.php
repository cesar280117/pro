<div class="row">
    <div class="col-lg-3">
        <div wire:loading wire:target="logo_empresa" class="form-group">
            <div class="d-flex align-items-center">
                <strong>Cargando logo de la empresa...</strong>
        ...
        <div class="form-group">
            @if ($logo_empresa)
                <img class="img-circle profile-user-img" style="width: 150px;height:150px;"
                    src="{{ $logo_empresa->temporaryUrl() }}" alt="No cuenta con imagen">
            @else
                <img class="img-circle profile-user-img" style="width: 150px;height:150px;"
                    src="{{ $logo_temporal ? asset('storage/' . $logo_temporal) : asset('storage/images/empresas/default.png') }}"
                    alt="No cuenta con imagen">
            @endif
        </div>
        <div class="form-group">
            <label>Logo de la empresa</label>
            <input type="file" class="form-control-file" wire:model="logo_empresa">
        </div>
    </div>
    <div class="col-lg">
        <div class="row">
            ...
            @if (!$id_empresa)
                <div class="col-lg">
                    <div class="form-group">
                        <label><span class="text-danger">*</span> RFC de la empresa</label>
                        <input type="text" class="form-control text-uppercase" wire:model="rfc">
            ...
            <div class="col-lg">
                <div class="form-group">
                    <label><span class="text-danger">*</span> Nombre de la empresa</label>
                    <input type="text" class="form-control" wire:model="nombre_empresa">
        ...
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                <div class="alert alert-danger">
                    <span>Los siguientes datos se utilizaran para poder iniciar sesión en la empresa</span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg">
                        <div class="form-group">
                            ...
                            @error('email') <span class="text-danger">El campo de correo electronico es
                                obligatorio</span>@enderror
                        </div>
                    </div>
                    <div class="col-lg">
                        <div class="form-group">
                            <label> <span class="text-danger">*</span>
                                {{ $id_empresa ? 'Password (en caso de querer modificar)' : 'password' }}</label>
